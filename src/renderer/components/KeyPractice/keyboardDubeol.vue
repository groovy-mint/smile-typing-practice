<template>
    <div id="keyboardWrapper">
      ...
      <div class="keyboardRow">
        ...
        <div class="key" ref="KeyQ"><div>ㅃ</div><div>ㅂ</div></div>
        <div class="key" ref="KeyW"><div>ㅉ</div><div>ㅈ</div></div>
        <div class="key" ref="KeyE"><div>ㄸ</div><div>ㄷ</div></div>
        <div class="key" ref="KeyR"><div>ㄲ</div><div>ㄱ</div></div>
        <div class="key" ref="KeyT"><div>ㅆ</div><div>ㅅ</div></div>
        <div class="key" ref="KeyY"><div>ㅛ</div></div>
        <div class="key" ref="KeyU"><div>ㅕ</div></div>
        <div class="key" ref="KeyI"><div>ㅑ</div></div>
        <div class="key" ref="KeyO"><div>ㅒ</div><div>ㅐ</div></div>
        <div class="key" ref="KeyP"><div>ㅖ</div><div>ㅔ</div></div>
        <div class="key"><div>[</div></div>
        <div class="key"><div>]</div></div>
        <div class="key"><div>\</div></div>
      </div>
      <div class="keyboardRow">
        ...
        <div class="key keyFinger" ref="KeyA"><div>ㅁ</div></div>
        <div class="key keyFinger" ref="KeyS"><div>ᆫ</div></div>
        <div class="key keyFinger" ref="KeyD"><div>ㅇ</div></div>
        <div class="key keyFinger" ref="KeyF"><div>ㄹ</div></div>
        <div class="key" ref="KeyG"><div>ㅎ</div></div>
        <div class="key" ref="KeyH"><div>ㅗ</div></div>
        <div class="key keyFinger" ref="KeyJ"><div>ㅓ</div></div>
        <div class="key keyFinger" ref="KeyK"><div>ㅏ</div></div>
        <div class="key keyFinger" ref="KeyL"><div>ㅣ</div></div>
        <div class="key keyFinger" ref="Semicolon"><div>:</div><div>;</div></div>
        <div class="key" ref="Quote"><div>"</div><div>'</div></div>
      ...
      <div class="keyboardRow">
        ...
        <div class="key" ref="KeyZ"><div>ㅋ</div></div>
        <div class="key" ref="KeyX"><div>ㅌ</div></div>
        <div class="key" ref="KeyC"><div>ㅊ</div></div>
        <div class="key" ref="KeyV"><div>ㅍ</div></div>
        <div class="key" ref="KeyB"><div>ㅠ</div></div>
        <div class="key" ref="KeyN"><div>ㅜ</div></div>
        <div class="key" ref="KeyM"><div>ㅡ</div></div>
        <div class="key" ref="Comma"><div>&lt;</div><div>,</div></div>
        <div class="key" ref="Period"><div>></div><div>.</div></div>
        <div class="key" ref="Slash"><div>?</div><div>/</div></div>
