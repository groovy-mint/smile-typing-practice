<template>
    <div id="keyboardWrapper">
      ...
      <div class="keyboardRow">
        ...
        <div class="key" ref="KeyQ"><div>Q</div></div>
        <div class="key" ref="KeyW"><div>W</div></div>
        <div class="key" ref="KeyE"><div>E</div></div>
        <div class="key" ref="KeyR"><div>R</div></div>
        <div class="key" ref="KeyT"><div>T</div></div>
        <div class="key" ref="KeyY"><div>Y</div></div>
        <div class="key" ref="KeyU"><div>U</div></div>
        <div class="key" ref="KeyI"><div>I</div></div>
        <div class="key" ref="KeyO"><div>O</div></div>
        <div class="key" ref="KeyP"><div>P</div></div>
        <div class="key"><div>{</div><div>[</div></div>
        <div class="key"><div>}</div><div>]</div></div>
        <div class="key"><div>|</div><div>\</div></div>
      </div>
      <div class="keyboardRow">
        ...
        <div class="key keyFinger" ref="KeyS"><div>S</div></div>
        <div class="key keyFinger" ref="KeyD"><div>D</div></div>
        <div class="key keyFinger" ref="KeyF"><div>F</div></div>
        <div class="key" ref="KeyG"><div>G</div></div>
        <div class="key" ref="KeyH"><div>H</div></div>
        <div class="key keyFinger" ref="KeyJ"><div>J</div></div>
        <div class="key keyFinger" ref="KeyK"><div>K</div></div>
        <div class="key keyFinger" ref="KeyL"><div>L</div></div>
      ...
      <div class="keyboardRow">
        ...
        <div class="key" ref="KeyZ"><div>Z</div></div>
        <div class="key" ref="KeyX"><div>X</div></div>
        <div class="key" ref="KeyC"><div>C</div></div>
        <div class="key" ref="KeyV"><div>V</div></div>
        <div class="key" ref="KeyB"><div>B</div></div>
        <div class="key" ref="KeyN"><div>N</div></div>
