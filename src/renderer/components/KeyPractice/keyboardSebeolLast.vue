<template>
    <div id="keyboardWrapper">
      <div class="keyboardRow">
        ...
        <div class="key" ref="Digit1"><div>ᆩ</div><div>ㅎ</div></div>
        <div class="key" ref="Digit2"><div>ᆰ</div><div>ㅆ</div></div>
        <div class="key" ref="Digit3"><div>ᆽ</div><div>ㅂ</div></div>
        <div class="key" ref="Digit4"><div>ᆵ</div><div>ㅛ</div></div>
        <div class="key" ref="Digit5"><div>ᆴ</div><div>ㅠ</div></div>
        ...
        <div class="key" ref="Minus"><div>;</div><div>)</div></div>
      ...
      <div class="keyboardRow">
        ...
        <div class="key" ref="KeyE"><div>ᆬ</div><div>ㅕ</div></div>
        <div class="key" ref="KeyR"><div>ᆶ</div><div>ㅐ</div></div>
        <div class="key" ref="KeyT"><div>ᆳ</div><div>ㅓ</div></div>
        <div class="key" ref="KeyY"><div>5</div><div>ㄹ</div></div>
        <div class="key" ref="KeyU"><div>6</div><div>ㄷ</div></div>
        <div class="key" ref="KeyI"><div>7</div><div>ㅁ</div></div>
        <div class="key" ref="KeyO"><div>8</div><div>ㅊ</div></div>
        <div class="key" ref="KeyP"><div>9</div><div>ㅍ</div></div>
        <div class="key"><div>%</div><div>(</div></div>
        <div class="key"><div>/</div><div>&lt;</div></div>
        <div class="key"><div>￦</div><div>:</div></div>
      </div>
      <div class="keyboardRow">
        ...
        <div class="key keyFinger" ref="KeyD"><div>ᆲ</div><div>ㅣ</div></div>
        <div class="key keyFinger" ref="KeyF"><div>ᆱ</div><div>ㅏ</div></div>
        <div class="key" ref="KeyG"><div>ㅒ</div><div>ㅡ</div></div>
        <div class="key" ref="KeyH"><div>0</div><div>ㄴ</div></div>
        <div class="key keyFinger" ref="KeyJ"><div>1</div><div>ㅇ</div></div>
        <div class="key keyFinger" ref="KeyK"><div>2</div><div>ㄱ</div></div>
        <div class="key keyFinger" ref="KeyL"><div>3</div><div>ㅈ</div></div>
        <div class="key keyFinger" ref="Semicolon"><div>4</div><div>ㅂ</div></div>
      ...
      <div class="keyboardRow">
        ...
        <div class="key" ref="KeyC"><div>ᆿ</div><div>ㅔ</div></div>
        <div class="key" ref="KeyV"><div>ᆪ</div><div>ㅗ</div></div>
        <div class="key" ref="KeyB"><div>?</div><div>ㅜ</div></div>
        <div class="key" ref="KeyN"><div>-</div><div>ㅅ</div></div>
        <div class="key" ref="KeyM"><div>"</div><div>ㅎ</div></div>
        <div class="key" ref="Comma"><div>,</div><div>,</div></div>
        <div class="key" ref="Period"><div>.</div><div>.</div></div>
